        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 md:gap-3 group" onClick={() => setMobileMenuOpen(false)}>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 p-1.5 md:p-2 rounded-xl">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6">
            <Link
              to="/"
              className="relative px-3 lg:px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors font-medium group"
            >
              <span>Products</span>
            ...
            >
              ...
              <div className={`absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                isDark ? 'bg-yellow-400/10' : 'bg-indigo-600/10'
              }`}></div>
            </button>
            ...
            <Link
              to="/cart"
              className="relative px-3 lg:px-4 py-2 glass hover:shadow-glow transition-all duration-300 rounded-xl group"
            >
              <div className="flex items-center gap-2">
                <svg className="w-6 h-6 text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <span className="hidden lg:inline font-medium text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Cart</span>
                {itemCount > 0 && (
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <Link
              to="/cart"
              className="relative p-2 glass rounded-xl"
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-gradient-to-r from-pink-500 to-purple-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                  {itemCount}
                </span>
              )}
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 space-y-3 animate-slide-down">
            <Link
              to="/"
              onClick={() => setMobileMenuOpen(false)}
              className="block px-4 py-3 glass rounded-xl text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors font-medium"
            >
              Products
            </Link>
            <Link
            ...
            <button
              ...
              className="w-full px-4 py-3 glass rounded-xl text-gray-700 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors font-medium text-left flex items-center justify-between"
            >
